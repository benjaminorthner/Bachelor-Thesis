...
\begin{figure}[!hbt]
    ...
    {
    \my         & 1             & 1         & $\sqrt{2}$& \mg 0     & 0         & 0         & 0         & 0         & 0        \\
    1           & \my           & $\sqrt{2}$& 1         & \mg 0     & 0         & 0         & 0         & 0         & 0        \\
    1           & $\sqrt{2}$    & \my       & 1         & \mg 0     & 0         & 0         & 0         & 0         & 0        \\
    $\sqrt{2}$  & 1             & 1         & \my       & \mg 0     & 0         & 0         & 0         & 0         & 0        \\
    \mg 0       & \mg 0         & \mg 0     & \mg 0     & \my       & 1         & $\sqrt{3}$& 2         & $\sqrt{3}$& 1        \\
    0           & 0             & 0         & 0         & 1         &  \my      & 1         & $\sqrt{3}$& 2         & $\sqrt{3}$ \\
    0           & 0             & 0         & 0         & $\sqrt{3}$& 1         & \my       & 1         & $\sqrt{3}$& 2        \\
    0           & 0             & 0         & 0         & 2         & $\sqrt{3}$& 1         &  \my      & 1         & $\sqrt{3}$ \\
    0           & 0             & 0         & 0         & $\sqrt{3}$& 2         & $\sqrt{3}$& 1         & \my       & 1        \\
    0           & 0             & 0         & 0         & 1         & $\sqrt{3}$& 2         & $\sqrt{3}$& 1         &  \my \\ };
    ...
    \node [draw, rectangle, fill=myellow, minimum size=1em, inner sep=0, label={[align=left, text width=170pt]right: $\begin{cases} 0 &\text{ for equal spin matrix} \\ 1 &\text{ for opposite spin matrix}\end{cases}$}] at ($(QD2) + (0, -1.6)$) {};
    
    \node [draw, rectangle, fill=mgreen, minimum size=1em, inner sep=0, label={[align=left, text width=170pt]right: We assume strong shielding between benzene and quantum dot $\Rightarrow$ no Coulomb interaction}] at ($(QD2) + (0, -3.)$) {0};
